...
const MeshyCard = ({ title, subtitle, children, className = "" }) => {
  return (
    <div className={`meshy-card bg-theme-surface backdrop-blur-sm border border-theme-border rounded-lg p-6 hover:bg-theme-surface/80 transition-all duration-300 ${className}`}>
      <div className="mb-4">
